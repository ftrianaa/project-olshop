...
import { Box, Button, ButtonGroup, Flex, FormControl, FormHelperText, FormLabel, Heading, HStack, IconButton, Radio, RadioGroup, Text, useDisclosure } from "@chakra-ui/react";
            ...
            <Box p={10}>
                ...
                <Flex justify='space-between'>
                    ...
                    <ButtonGroup isAttached variant='solid' onClick={onOpen} colorScheme='green'>
                        <Button textTransform='uppercase' letterSpacing={2}>confirm payment</Button>
                        <IconButton aria-label='Add to friends' icon={<QuestionOutlineIcon />} />
                    </ButtonGroup>
                </Flex>
            </Box>
            <ConfirmPaymentModal
