import { Box, Button, Divider, Flex, FormControl, FormHelperText, Grid, GridItem, Heading, Input, InputGroup, InputRightElement, Spacer, Text } from "@chakra-ui/react";
...
export default function Footer() {
    return (
        <>
            ...
            <Flex mt={5} justify='center' align='center' display={['none','flex','flex']}>
                <Box w={['95%','75%','50%']}>
                    <Flex align='center' fontSize={['18px','20px','25px']}>
                        <Text  display='flex' alignItems='center' justifyContent='center'> <FaPhone /> 080808</Text>
                        <Spacer />
                        <Text display='flex' alignItems='center' justifyContent='center'> <FaInstagram /> olimall</Text>
                        <Spacer />            
                        <Text display='flex' alignItems='center' justifyContent='center'>  <FaEnvelope /> olimall@index.co</Text>
                    </Flex>
                </Box>
            </Flex>
            <Box bgColor='white' textTransform='capitalize' fontSize='15px'>
                <Grid templateColumns={['repeat(2, 1fr)', 'repeat(2, 1fr)', 'repeat(5, 1fr)']} gap={5}>
                    <GridItem colSpan={[1, 1, 1]} >
                        <Heading textTransform='uppercase' fontSize='30px' m={5}>help</Heading>
                        <Box textAlign='left'>
                    ...
                    <GridItem colSpan={[1, 1, 1]}>
                        <Heading textTransform='uppercase' fontSize='30px' m={5}>quick links</Heading>
                        <Box textAlign='left'>
                    ...
                    <GridItem colSpan={[2, 2, 1]} >
                        <Heading textTransform='uppercase' fontSize='30px' m={5}>about</Heading>
            ...
            <Box bgColor='white' fontSize='30px' m={10} textAlign='left'>
                ...
                <Text fontSize='20px' color='maroon'>&copy;2023 Fitriana</Text>
            </Box>
        </>
    )
}